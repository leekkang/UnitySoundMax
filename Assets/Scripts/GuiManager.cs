...
public class GuiManager : Singleton<GuiManager> { //manager를 singleton으로 설정
    ...
    public void Open() {
        ...
        mPanelMain = GameObject.Find("panel_select");
        mPanelMain = GameObject.Find("panel_option");
        mPanelMain = GameObject.Find("panel_ingame");
        mPanelMain = GameObject.Find("panel_result");
    }
